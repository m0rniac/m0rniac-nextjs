        ...
        <div className="container-fluid"><br /><br />
            ...
            <div className="container-fluid card text-white bg-dark mb-3 text-center">
                ...
                <div className="card-body text-center">
                    ...
                    <p className="card-text text-center">Puedes adquirir más información al respecto a través de mi Direct Manager: <a href="https://www.instagram.com/rusev.cm/" target="_blank" rel="noopener noreferrer">@rusev.cm</a></p>
                </div>
            </div>
        </div>
    );
